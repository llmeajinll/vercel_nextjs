  ...
  return (
    <div className='flex border border-stone-300 w-[1080px] mt-2.5 pl-3 pr-2.5 py-1.5 rounded-md text-sm text-stone-600'>
      <div className='flex items-center justify-center mr-2.5'>
        <input
          className='w-4 h-4 border border-stone-300 checked:bg-sky-300 cheked:text-white rounded-sm
      ...
      <div
        className={`basis-[40px] px-1.5 py-0.5 rounded border border-${todo.tag[0].color}-600 bg-${todo.tag[0].color}-100 text-${todo.tag[0].color}-600 flex items-center justify-center`}
      >
        {todo.tag[0].tag}
      </div>
